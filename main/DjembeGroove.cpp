...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst15 = std::pow(0.00100000005f, (2.08333325f / fConst0));
		fConst16 = (std::cos((5403.53955f / fConst0)) * (0.0f - (2.0f * fConst15)));
		fConst17 = mydsp_faustpower2_f(fConst15);
		fConst18 = std::pow(0.00100000005f, (1.96078432f / fConst0));
		fConst19 = (std::cos((4146.90234f / fConst0)) * (0.0f - (2.0f * fConst18)));
		...
		fConst24 = std::pow(0.00100000005f, (1.75438595f / fConst0));
		fConst25 = (std::cos((1633.62817f / fConst0)) * (0.0f - (2.0f * fConst24)));
		fConst26 = mydsp_faustpower2_f(fConst24);
		fConst27 = std::pow(0.00100000005f, (1.66666663f / fConst0));
		fConst28 = (std::cos((376.991119f / fConst0)) * (0.0f - (2.0f * fConst27)));
