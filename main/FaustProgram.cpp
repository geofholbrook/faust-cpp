 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec6[0] = (fTemp2 - ((fConst19 * fRec6[1]) + (fConst20 * fRec6[2])));
			fRec7[0] = (fTemp2 - ((fConst22 * fRec7[1]) + (fConst23 * fRec7[2])));
			fRec8[0] = (fTemp2 - ((fConst25 * fRec8[1]) + (fConst26 * fRec8[2])));
			fRec9[0] = (fTemp2 - ((fConst28 * fRec9[1]) + (fConst29 * fRec9[2])));
			fRec10[0] = (fTemp2 - ((fConst31 * fRec10[1]) + (fConst32 * fRec10[2])));
			fRec11[0] = (fTemp2 - ((fConst34 * fRec11[1]) + (fConst35 * fRec11[2])));
			fRec12[0] = (fTemp2 - ((fConst37 * fRec12[1]) + (fConst38 * fRec12[2])));
			fRec13[0] = (fTemp2 - ((fConst40 * fRec13[1]) + (fConst41 * fRec13[2])));
			fRec14[0] = (fTemp2 - ((fConst43 * fRec14[1]) + (fConst44 * fRec14[2])));
			fRec15[0] = (fTemp2 - ((fConst46 * fRec15[1]) + (fConst47 * fRec15[2])));
			fRec16[0] = (fTemp2 - ((fConst49 * fRec16[1]) + (fConst50 * fRec16[2])));
			fRec17[0] = (fTemp2 - ((fConst52 * fRec17[1]) + (fConst53 * fRec17[2])));
			fRec18[0] = (fTemp2 - ((fConst55 * fRec18[1]) + (fConst56 * fRec18[2])));
			fRec19[0] = (fTemp2 - ((fConst58 * fRec19[1]) + (fConst59 * fRec19[2])));
			fRec20[0] = (fTemp2 - ((fConst61 * fRec20[1]) + (fConst62 * fRec20[2])));
			fRec21[0] = (fTemp2 - ((fConst64 * fRec21[1]) + (fConst65 * fRec21[2])));
			fRec22[0] = (fTemp2 - ((fConst67 * fRec22[1]) + (fConst68 * fRec22[2])));
			fRec23[0] = (fTemp2 - ((fConst70 * fRec23[1]) + (fConst71 * fRec23[2])));
			fRec24[0] = (fTemp2 - ((fConst73 * fRec24[1]) + (fConst74 * fRec24[2])));
			output0[i] = FAUSTFLOAT((0.0500000007f * ((((((((((((((((((((fRec0[0] + (0.25f * (fRec6[0] - fRec6[2]))) + (0.111111112f * (fRec7[0] - fRec7[2]))) + (0.0625f * (fRec8[0] - fRec8[2]))) + (0.0399999991f * (fRec9[0] - fRec9[2]))) + (0.027777778f * (fRec10[0] - fRec10[2]))) + (0.0204081628f * (fRec11[0] - fRec11[2]))) + (0.015625f * (fRec12[0] - fRec12[2]))) + (0.0123456791f * (fRec13[0] - fRec13[2]))) + (0.00999999978f * (fRec14[0] - fRec14[2]))) + (0.00826446246f * (fRec15[0] - fRec15[2]))) + (0.0069444445f * (fRec16[0] - fRec16[2]))) + (0.00591715984f * (fRec17[0] - fRec17[2]))) + (0.00510204071f * (fRec18[0] - fRec18[2]))) + (0.00444444455f * (fRec19[0] - fRec19[2]))) + (0.00390625f * (fRec20[0] - fRec20[2]))) + (0.00346020772f * (fRec21[0] - fRec21[2]))) + (0.00308641978f * (fRec22[0] - fRec22[2]))) + (0.00277008303f * (fRec23[0] - fRec23[2]))) + (0.00249999994f * (fRec24[0] - fRec24[2]))) - fRec0[2])));
			iVec0[1] = iVec0[0];
			iRec3[1] = iRec3[0];
			fRec2[2] = fRec2[1];
			fRec2[1] = fRec2[0];
