...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceResetUserInterface() {
		...
		fEntry3 = FAUSTFLOAT(1000.0f);
		fEntry4 = FAUSTFLOAT(100.0f);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow4 = (float(fEntry0) / fSlow3);
		...
		float fSlow16 = (1.0f / std::max<float>(1.0f, (fConst2 * float(fEntry2))));
		float fSlow17 = (0.00100000005f * float(fEntry3));
		float fSlow18 = float(fEntry4);
		float fSlow19 = (fConst4 * std::cos((fConst5 * fSlow18)));
		float fSlow20 = (fConst8 * std::cos((fConst5 * (fSlow18 + 200.0f))));
		float fSlow21 = (fConst11 * std::cos((fConst5 * (fSlow18 + 400.0f))));
		float fSlow22 = (fConst14 * std::cos((fConst5 * (fSlow18 + 600.0f))));
		float fSlow23 = (fConst17 * std::cos((fConst5 * (fSlow18 + 800.0f))));
		float fSlow24 = (fConst20 * std::cos((fConst5 * (fSlow18 + 1000.0f))));
		float fSlow25 = (fConst23 * std::cos((fConst5 * (fSlow18 + 1200.0f))));
		float fSlow26 = (fConst26 * std::cos((fConst5 * (fSlow18 + 1400.0f))));
		float fSlow27 = (fConst29 * std::cos((fConst5 * (fSlow18 + 1600.0f))));
		float fSlow28 = (fConst32 * std::cos((fConst5 * (fSlow18 + 1800.0f))));
		float fSlow29 = (fConst35 * std::cos((fConst5 * (fSlow18 + 2000.0f))));
		float fSlow30 = (fConst38 * std::cos((fConst5 * (fSlow18 + 2200.0f))));
		float fSlow31 = (fConst41 * std::cos((fConst5 * (fSlow18 + 2400.0f))));
		float fSlow32 = (fConst44 * std::cos((fConst5 * (fSlow18 + 2600.0f))));
		float fSlow33 = (fConst47 * std::cos((fConst5 * (fSlow18 + 2800.0f))));
		float fSlow34 = (fConst50 * std::cos((fConst5 * (fSlow18 + 3000.0f))));
		float fSlow35 = (fConst53 * std::cos((fConst5 * (fSlow18 + 3200.0f))));
		float fSlow36 = (fConst56 * std::cos((fConst5 * (fSlow18 + 3400.0f))));
		float fSlow37 = (fConst59 * std::cos((fConst5 * (fSlow18 + 3600.0f))));
		float fSlow38 = (fConst62 * std::cos((fConst5 * (fSlow18 + 3800.0f))));
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec6[0] = (fSlow17 + (0.999000013f * fRec6[1]));
			iRec5[0] = ((iVec0[1] + iRec5[1]) % int((44.0999985f * fRec6[0])));
			int iTemp0 = (iRec5[0] < 100);
			iVec1[0] = iTemp0;
			...
			fRec0[0] = (fTemp2 - ((fSlow19 * fRec0[1]) + (fConst6 * fRec0[2])));
			fRec7[0] = (fTemp2 - ((fSlow20 * fRec7[1]) + (fConst9 * fRec7[2])));
			fRec8[0] = (fTemp2 - ((fSlow21 * fRec8[1]) + (fConst12 * fRec8[2])));
			fRec9[0] = (fTemp2 - ((fSlow22 * fRec9[1]) + (fConst15 * fRec9[2])));
			fRec10[0] = (fTemp2 - ((fSlow23 * fRec10[1]) + (fConst18 * fRec10[2])));
			fRec11[0] = (fTemp2 - ((fSlow24 * fRec11[1]) + (fConst21 * fRec11[2])));
			fRec12[0] = (fTemp2 - ((fSlow25 * fRec12[1]) + (fConst24 * fRec12[2])));
			fRec13[0] = (fTemp2 - ((fSlow26 * fRec13[1]) + (fConst27 * fRec13[2])));
			fRec14[0] = (fTemp2 - ((fSlow27 * fRec14[1]) + (fConst30 * fRec14[2])));
			fRec15[0] = (fTemp2 - ((fSlow28 * fRec15[1]) + (fConst33 * fRec15[2])));
			fRec16[0] = (fTemp2 - ((fSlow29 * fRec16[1]) + (fConst36 * fRec16[2])));
			fRec17[0] = (fTemp2 - ((fSlow30 * fRec17[1]) + (fConst39 * fRec17[2])));
			fRec18[0] = (fTemp2 - ((fSlow31 * fRec18[1]) + (fConst42 * fRec18[2])));
			fRec19[0] = (fTemp2 - ((fSlow32 * fRec19[1]) + (fConst45 * fRec19[2])));
			fRec20[0] = (fTemp2 - ((fSlow33 * fRec20[1]) + (fConst48 * fRec20[2])));
			fRec21[0] = (fTemp2 - ((fSlow34 * fRec21[1]) + (fConst51 * fRec21[2])));
			fRec22[0] = (fTemp2 - ((fSlow35 * fRec22[1]) + (fConst54 * fRec22[2])));
			fRec23[0] = (fTemp2 - ((fSlow36 * fRec23[1]) + (fConst57 * fRec23[2])));
			fRec24[0] = (fTemp2 - ((fSlow37 * fRec24[1]) + (fConst60 * fRec24[2])));
			fRec25[0] = (fTemp2 - ((fSlow38 * fRec25[1]) + (fConst63 * fRec25[2])));
	...
	FAUST_ADDNUMENTRY("period", fEntry3, 1000.0f, 50.0f, 2000.0f, 10.0f);
	FAUST_ADDNUMENTRY("strikePosition", fEntry1, 0.5f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDNUMENTRY("strikeSharpness", fEntry2, 0.5f, 0.0f, 1.0f, 0.01f);
#endif
...
void Djembe::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float Djembe::getParamValue(const std::string& path)
{
